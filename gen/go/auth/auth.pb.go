...
const file_protos_auth_proto_rawDesc = "" +
	"\n" +
	"\x11protos/auth.proto\x12\x04auth\"I\n" +
	...
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponseB;Z9github.com/Vy4cheSlave/grpc_user-manager/gen/go/auth;authb\x06proto3"
